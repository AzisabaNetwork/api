...
object DatabaseManager {
    ...
    init {
        ...
        transaction(azisabaApi) {
            ...
            SchemaUtils.create(AzisabaAPI.StoreRequestsTable)
            SchemaUtils.create(AzisabaAPI.StoreFulfillmentsTable)
            SchemaUtils.create(AzisabaAPI.StoreAdminAuditTable)
        }
